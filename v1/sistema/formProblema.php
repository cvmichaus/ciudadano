                 ...
                 <div class="row">
                       <div class="col-md-12">
                           ...
                           <hr>
                            ...
                            <div class="row">
                            <div class="col-md-12">
                            <p style="font-family: Roboto;font-size: 11px;color:#a31d24;text-transform: uppercase;" >Problemática significativa del contexto <span style="cursor: pointer;" class="oi oi-info" data-toggle="modal" data-target="#exampleModal" ></span></p>
                            </div>
                            </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       Hago la descripción de una situación escolar, social, personal, familiar, política, artística, experimental, cultural, ambiental, tecnológica o entre otras económicas que se ha pertinente relevante con sentido y real; a través de la cual busco orientar el proceso de formación de mis estudiantes de la mano del desarrollo de competencias del control ciudadano del público.
       <br><br>
      Esta descripción la problemática a partir de cuestionamientos iniciales que compartiré y enriqueceré con mis estudiantes, quienes enmarcaran la problemática resultante en un contexto especifico de su entorno parto de la premisa de que problemática que surge solo de la parte docente podría incluso carecer de sentido para los estudiantes. 
      </div>
...
$Query = "SELECT * FROM  problema_sig_contexto  WHERE `CodUF` =  ".$ID_UF." AND NumSD = ".$CODSD." ";
  ...
  <textarea class="form-control" id="problematica" required name="problematica" aria-describedby="problematica" placeholder="Escriba Aqui"></textarea>
...
<form method="post" action="DB_MOD_PROBLEMATICA.php">
  ...
  <textarea  style="border: 0;background-color: #ccc;" class="form-control" id="problematica" readonly required name="problematica" aria-describedby="problematica" placeholder="Escriba Aqui"><?php echo $datos["Problematica"]; ?></textarea>
