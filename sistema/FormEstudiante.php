...
<div class="row">
           ...
           <div class="col-sm-10">
            ...
            <div class="row" style="padding-bottom:10px;padding-top: 20px;">
                                  <div class="col-md-3">
                                         ...
                                         <a href="detalles_UF.php?coduf=<?php echo base64_encode($CodUF);?>&codns=<?php echo $codigoNS ?>&reenvio=4"  style="color: #a31d24;">&nbsp;<- Regresar </a>
  ...
  font-weight: bold;
  letter-spacing: 0;
  line-height: 24px;">Estudiante</label>
                 </div>
            </div>
            ...
            <div class="row">
                 <div class="col-sm-3" style="box-sizing: border-box; height: 337px;width: 300px; border: 1px solid #D4D4D4; border-radius: 10px; background-color: #FFFFFF;">
                ...
                <div class="col-sm-10">
                <input type="text" style=" height: 30px;width: 200px;" class="form-control" id="usuario" name="usuario" placeholder="Usuario">
                </div>
                </div>
  ...
  right: 1px;
                 ...
                 <div class="col-sm-8" style="box-sizing: border-box; height: 337px;width: 663px; border: 1px solid #D4D4D4; border-radius: 10px;background-color: #FFFFFF;">
                  ...
                  <label style="color: #666666; font-family: Lato; font-size: 12px; letter-spacing: 0;  line-height: 15px;padding-top: 20px;">DATOS ALUMNO</label>

                  <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Nombre</label>
                <div class="col-sm-10">
                <input type="text" style=" height: 30px;width: 452px;" class="form-control" id="Nombre" name="Nombre" placeholder="Nombre">
                </div>
                </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                <input type="text" style=" height: 30px;width: 452px;" class="form-control" id="Apellidos" name="Apellidos" placeholder="Apellidos">
                </div>
                </div>

                 <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Grado</label>
                <div class="col-sm-10">
                <input type="text" style=" height: 30px;width: 452px;" class="form-control" id="Grado" name="Grado" placeholder="Grado">
                </div>
                </div>
                ...
                <div class="col-sm-10">
                <input type="text" style=" height: 30px;width: 452px;" class="form-control" id="Grupo" name="Grupo" placeholder="Grupo">
                </div>
                </div>
