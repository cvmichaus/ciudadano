                                     ...
                                     <div class="row">
                                      <div class="col-6">
                                        ...
                                        <div class="col-3"></div>
                                         <div class="col-3">
                                          <br><br><br>
                                           <a class="btn btn-sm btn-primary btn-block" href="EditarUsu.php?codUsu=<?php echo $_GET["codUsu"]; ?>" style="background-color:#a31d24;color:#fff;font-size: 15px; " > Editar </a>
