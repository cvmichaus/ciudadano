                ...
                <div class="col-md-10">
                   ...
                   <div class="row" style="padding-bottom: 20px;padding-top: 20px;">
                                    <div class="col-3">
                                           ...
                                           <a href="detalles_UF.php?codns=<?php echo $codns;?>&coduf=<?php echo base64_encode($COD_UF);?>&iduser=<?php echo $iduser;?>"  style="color: #a31d24;font-size: 12px;text-decoration: none;"><i class="fa fa-arrow-left" aria-hidden="true"></i> Regresar </a>
                      ...
                      ?>
                       <form method="post" action="DB_MOD_UF.php">
                              ...
                              <div class="col-md-2">
                                  ...
                                  <input type="number" class="form-control" onblur="validarvalor();" id="nsecuencias" name="nsecuencias" min="<?php echo $datosig['NSDidacticas']; ?>" aria-describedby="nsecuencias" max="30" value="<?php echo $datosig["NSDidacticas"]; ?>" required placeholder="Escriba Aqui">

                                   <inpu type="hidden"  id="valorsecuencia" name="valorsecuencia" value="<?php echo $datosig['NSDidacticas']; ?>">
  ...
  $(window).on("load resize", function() {
    ...
    function validarvalor(){
      ...
      var a = document.getElementById('nsecuencias'); 
      var b = document.getElementById('valorsecuencia'); 
      if( a.value >= 31){
       document.getElementById('nsecuencias').value = document.getElementById('valorsecuencia').value;
